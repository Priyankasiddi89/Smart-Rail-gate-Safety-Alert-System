...
unsigned long counterChannelNumber =  258107;            // Channel ID
const char * myCounterReadAPIKey = "P2KKNLIMQY6REU4T"; // Read API Key
const int FieldNumber1 = 1;

//---------WRITE Channel Details---------//
unsigned long myChannelNumber = 256260;
const char * myWriteAPIKey = "744U0VQJMWS8EW69";
